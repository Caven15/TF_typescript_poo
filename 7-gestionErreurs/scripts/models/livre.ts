...
import { AnneePublicationInvalide } from "../errors/anneePublicationInvalid";
...
export abstract class Livre implements ILivre {
    ...
    constructor(titre: string, auteur: string, anneePublication: number | undefined = new Date().getFullYear(), prix: number) {
        ...
        if (anneePublication < 1800){
            ...
            throw new AnneePublicationInvalide("L'année de publciation ne peut être ultérieur a m'année en cours ");
        }
