...
const livre1 = new livreLudique_1.LivreLudique("Le seigneur des anneaux", "Jhon Doe", 1954, "+10", 75);
const livre2 = new livreTechnique_1.LivreTechnique("Ts pour les nuls 🤯", "Tf_fullstack_python_2", 1750, "informatique", "Débutant", 20);
const livre3 = new livreLudique_1.LivreLudique("Martine à la plage", "Jhon Doe", 2004, "✔", 0.50);
const livreLudique4 = new livreLudique_1.LivreLudique("Martine à la plage - 2", "Jhon Doe", 2004, "✔", 0.50);
const livreTechnique1 = new livreTechnique_1.LivreTechnique("Paradigne POO", "Microsoft", 2007, "Informatique", "expert", 50);
